...
Design of the Database Schema and the overall DB design from DB beaver. including foreign keys
Link to the DB scripts for creating the DB and the relationships between tables.
\subsection{Developed Applications}
In the following section I will discuss the applications which where developed as part of the Xpire system.
\subsubsection{Mobile Application}
Over view of the mobile application. Discussion of the functionality, scanning barcodes, communication with the backend. display on multiple devices. Input forms for user input and submission.
\subsubsection{Web Application}
Web application - features and functionality. Display
\subsubsection{Web Services}
Webservices written in Java spring boot
- overview of the services.
-- how they communicate with the DB 
-- the repository pattern - Gang of Four
